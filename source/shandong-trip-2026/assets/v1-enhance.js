...
function enhanceDay(id){
 ...
 document.addEventListener('click',e=>{const t=e.target.closest('[data-copy]');if(!t)return;e.preventDefault();e.stopImmediatePropagation();robustCopy(t.dataset.copy)},true);
